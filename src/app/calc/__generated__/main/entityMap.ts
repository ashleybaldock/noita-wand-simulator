...
export const entityToActionIds = {
  ...
  'data/entities/projectiles/deck/white_hole.xml': ['WHITE_HOLE'],
  ...
  'data/entities/projectiles/deck/white_hole_giga.xml': ['WHITE_HOLE_GIGA'],
  ...
  'data/entities/projectiles/deck/lance_holy.xml': ['LANCE_HOLY'],
  ...
  'data/entities/projectiles/deck/healhurt.xml': ['ANTIHEAL'],
  ...
  'data/entities/projectiles/deck/touch_piss.xml': ['TOUCH_PISS'],
  'data/entities/projectiles/deck/touch_grass.xml': ['TOUCH_GRASS'],
  ...
  'data/entities/projectiles/deck/mass_polymorph.xml': ['MASS_POLYMORPH'],
  ...
  'data/entities/projectiles/deck/sea_mimic.xml': ['SEA_MIMIC'],
