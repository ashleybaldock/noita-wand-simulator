...
const uiSpriteDefinition = [
  ...
  ['icon.maxuses', `url('data/wand/icon_action_max_uses.png')`],
  ['icon.remaininguses', `url('data/wand/icon_action_max_uses.png')`],

  ['icon.recursion', `url('data/eval/icon_recursion.png')`],
  ['icon.iteration', `url('data/eval/icon_iteration.png')`],
